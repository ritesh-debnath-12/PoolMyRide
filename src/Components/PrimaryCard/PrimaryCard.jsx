...
function PrimaryCard(){
    ...
    return (
            <div className="bg-white text-black p-6 pt-2 rounded-lg shadow-[5px_5px_rgba(113,_128,_150,_0.4),_10px_10px_rgba(113,_128,_150,_0.3),_15px_15px_rgba(113,_128,_150,_0.2),_20px_20px_rgba(113,_128,_150,_0.1),_25px_25px_rgba(113,_128,_150,_0.05)]
             w-96 max-w-md mb-10 md:mb-0">
                <div className="flex justify-around mb-4">
                    <button className="focus:outline-none font-semibold p-1 underline-animation"><img src="src/assets/Steering-wheel.svg" alt="Drive" />Drive</button>
                    <button className="focus:outline-none font-semibold p-1 underline-animation"><img src="src/assets/car.svg" alt="car" />Ride</button>
                </div>
                <hr />
